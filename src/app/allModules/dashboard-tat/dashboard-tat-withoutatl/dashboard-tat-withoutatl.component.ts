...
@Component({
  selector: 'app-dashboard-tat-withoutatl',
  templateUrl: './dashboard-tat-withoutatl.component.html',
  styleUrls: ['./dashboard-tat-withoutatl.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class DashboardTatWithoutatlComponent implements OnInit {
