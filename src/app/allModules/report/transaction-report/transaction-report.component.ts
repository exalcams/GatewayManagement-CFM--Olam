...
export class TransactionReportComponent implements OnInit, OnDestroy {
  ...
  GetAllReportsBasedOnFilter(): void {
    if (this.reportFormGroup.valid) {
      ...
      // tslint:disable-next-line:max-line-length
      if ((this.reportFilters.VEHICLE_NO !== '' && this.reportFilters.VEHICLE_NO !== null) && (this.reportFilters.PLANT === '' || this.reportFilters.PLANT === null) && ((this.reportFilters.FROMDATE === '' && this.reportFilters.TODATE === '') || (this.reportFilters.FROMDATE === null && this.reportFilters.TODATE === null))) {
      ...
      // tslint:disable-next-line:max-line-length
      else if ((this.reportFilters.PLANT === '' || this.reportFilters.PLANT === null) && (this.reportFilters.VEHICLE_NO === '' || this.reportFilters.VEHICLE_NO === null) && ((this.reportFilters.FROMDATE !== '' && this.reportFilters.TODATE !== '') && (this.reportFilters.FROMDATE !== null && this.reportFilters.TODATE !== null))) {
        // this.authenticationDetails.userID, VEHICLE_NO, FROMDATE, TODATE
        ...
        this._reportService.GetAllReportsBasedOnPlantFilter(this.reportFilters)
          .subscribe((data) => {
            this.AllTransactionReportDetails = data as TransactionReportDetails[];
            this.dataSource = new MatTableDataSource(this.AllTransactionReportDetails);
            this.dataSource.sortingDataAccessor = (item, property) => {
  ...
  clearFromToDateAndVehicleNo(): void {
